...
public class WP_InteracaoProduto extends BaseTest implements GlobalConstants { 
	...
	public void setUp(@Optional("@os='android'") String deviceQuery) throws Exception{
		...
		dc.setCapability("deviceQuery",Huawei+"or"+LGE5X+"or"+A8Plus+"or"+S7Edge+"or"+ XperiaXA + "or" + S8);
	...
	@Test
	 public void testeinteracaoproduto() {
    	  ...
    	  driver.findElement(By.xpath("//*[@id='edEmail']")).sendKeys("tedmarketplaces@yahoo.com");

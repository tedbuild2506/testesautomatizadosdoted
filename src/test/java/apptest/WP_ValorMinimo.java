...
public class WP_ValorMinimo extends BaseTest implements GlobalConstants {
	...
	public void test_SemDistribuidor() {
		...
		driver.findElement(By.xpath("//*[@text='Pagar R$ 20,28']")).click();
		try{Thread.sleep(esperandogifintermediario+0500);} catch(Exception ignore){}
		...
		driver.swipe(584, 1568, 565, 1096, 197);
		driver.findElement(By.xpath("//*[@text='Pagar R$ 20,28']")).click();
		driver.findElement(By.xpath("//*[@text='Está bem']")).click();	
		}
	}

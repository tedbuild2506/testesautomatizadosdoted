	...
	public void setUp(@Optional("@os='android'") String deviceQuery) throws Exception{
	 ...
	 public void testeMarketplace() {
	  ...
	  client.setShowReport(false);
  	  new WebDriverWait(driver, 30, 3000).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='Acesse sua conta']"))).click();
	  ...
	  client.setShowReport(false);
	  new WebDriverWait(driver, 30, 4000).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='imgCart']"))).click();
	  client.setShowReport(true);
	  driver.findElement(By.xpath("//*[@id='ze_delivery_store_button']")).click();
	  new WebDriverWait(driver, 30, 4000).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='ALLOW']"))).click();
	  client.setShowReport(false);
	  new WebDriverWait(driver, 30, 4000).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='addQuantityView' and @height>0 and ./parent::*[./parent::*[./preceding-sibling::*[@text='Skol 300ml | Apenas o Líquido.']]]]")));
	  client.setShowReport(true);
	  ...
	  client.setShowReport(false);
	  new WebDriverWait(driver, 30, 4000).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='myDataTitleView']")));
	  client.setShowReport(true);
	  ...
	  new WebDriverWait(driver, 30, 4000).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='CONFIRMAR']"))).click();
	  client.setShowReport(false);
	  new WebDriverWait(driver, 30, 4000).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='Pagina inicial']")));
	  client.setShowReport(true);
	  ...
	  client.setShowReport(false);
	  new WebDriverWait(driver, 30, 4000).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='details_button' and @height>0 and ./parent::*[./preceding-sibling::*[@text='Cerveja Wals Evita 375ml']]]")));
	  client.setShowReport(true);
	  ...
	  client.setShowReport(false);
	  new WebDriverWait(driver, 30, 4000).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='addQuantityView']")));
	  client.setShowReport(true);
	  driver.findElement(By.xpath("//*[@id='addQuantityView']")).click();
	  driver.findElement(By.xpath("//*[@text='Adicionar ao carrinho']")).click();
	  client.setShowReport(false);
	  new WebDriverWait(driver, 30, 4000).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@contentDescription='TODO']")));
	  client.setShowReport(true);
	  driver.findElement(By.xpath("//*[@contentDescription='TODO']")).click();
	  client.setShowReport(false);
	  new WebDriverWait(driver, 30, 4000).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='deliveryAddressTitleView']")));
	  client.setShowReport(false);
	  ...
	  client.setShowReport(false);
	  new WebDriverWait(driver, 30, 4000).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@text='Ver meus pedidos']")));
	  client.setShowReport(true);

...
public class WP_CadastroEmBranco extends BaseTest implements GlobalConstants { 
	...
	public void setUp(@Optional("@os='android'") String deviceQuery) throws Exception{
		...
		dc.setCapability("deviceQuery",S7+"or"+LGE5X+"or"+S7Edge+"or"+S8+ "or"+ LGG5+"or"+ SM+"or"+ XperiaXA+"or"+ LG60+"or"+ S6Plus+"or"+ A8Plus+"or"+ Huawei);		driver = new AndroidDriver<>(new URL(getProperty("url",cloudProperties) +"/wd/hub"), dc);
